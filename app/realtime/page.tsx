    ...
    if (!hasSupabaseCredentials) {
        return (
            <main className="min-h-screen bg-gray-50 p-6">
                <div className="mx-auto flex max-w-3xl flex-col gap-4 rounded-xl border border-dashed border-gray-300 bg-white p-10 text-center shadow-sm">
                    <p className="text-sm font-semibold uppercase tracking-[0.28em] text-gray-500">Realtime demo</p>
                    <h1 className="text-3xl font-bold text-gray-900">Supabase credentials not configured</h1>
                    <p className="text-gray-600">
                        Add <code className="rounded bg-gray-100 px-1 py-0.5 text-xs">NEXT_PUBLIC_SUPABASE_URL</code> and{' '}
                        <code className="rounded bg-gray-100 px-1 py-0.5 text-xs">NEXT_PUBLIC_SUPABASE_ANON_KEY</code> to enable the realtime chat page.
                    </p>
                    <div className="flex flex-wrap justify-center gap-3 pt-2">
                        <a href="/" className="rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700">
                            Return home
                        </a>
                        <a
                            href="https://supabase.com/dashboard/projects"
                            className="rounded-md border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:border-gray-400"
                        >
                            Configure Supabase
                        </a>
                    </div>
