...
export default function AstraChat({ position = "bottom-right" }: AstraChatProps) {
    ...
    const buttonPositionClass = position === "bottom-left" ? "left-6" : "right-6";
    ...
    return (
        <>
            ...
            <button
                ...
                className={`group fixed bottom-6 ${buttonPositionClass} z-30 flex h-16 w-16 items-center justify-center rounded-full border border-cyan-400/60 bg-slate-950/90 shadow-[0_0_35px_rgba(34,211,238,0.7)] backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:border-fuchsia-400 hover:shadow-[0_0_45px_rgba(236,72,153,0.8)]`}
            >
